...
public class SoloTempDto {
	private String solo_now_member;
	private String solo_num;
	private String solo_min_member;
	private String solo_member;
	private String solo_end_date;
	private String solo_date;
	private int solo_loc_num;
	private String solo_id;
	private String solo_money;
	...
	public String getSolo_now_member() {
		return solo_now_member;
	}
	public void setSolo_now_member(String solo_now_member) {
		this.solo_now_member = solo_now_member;
	}
	public String getSolo_num() {
		return solo_num;
	}
	public void setSolo_num(String solo_num) {
		this.solo_num = solo_num;
	}
	public String getSolo_min_member() {
		return solo_min_member;
	}
	public void setSolo_min_member(String solo_min_member) {
		this.solo_min_member = solo_min_member;
	}
	public String getSolo_member() {
		return solo_member;
	}
	public void setSolo_member(String solo_member) {
	...
	public String getSolo_money() {
		return solo_money;
	}
	public void setSolo_money(String solo_money) {
