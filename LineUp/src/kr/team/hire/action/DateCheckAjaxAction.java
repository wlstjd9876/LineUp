...
public class DateCheckAjaxAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(!request.getParameter("team_date").equals("")) {
			date = request.getParameter("team_date");
			date_s = date.split("-");
		}
		if(!request.getParameter("team_end_date").equals("")) {
			end_date = request.getParameter("team_end_date");
