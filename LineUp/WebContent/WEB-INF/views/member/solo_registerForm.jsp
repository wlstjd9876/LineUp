...
<body>
		<div class="form-panel align-center">
			...
			<div class="form-content">
				<form action="solo_register.do" method="post" id="register_form">
					...
					<div class="form-group align-left">
						...
						<input type="text" class="form-control" id="name" name="name" placeholder="Enter Name" maxlength="10" autocomplete="off">
					</div>
					<div class="form-group align-left">
					...
					<div class="form-group align-left">
						...
						<input type="text" class="form-control" id="nick" name="nick" placeholder="Enter NickName" maxlength="10"  autocomplete="off">
