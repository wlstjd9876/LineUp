...
<meta charset="UTF-8">
<title>팀 회원 수정</title>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/modify_team.js"></script>
</head>
<body>
		<div class="form-panel align-center">
			...
			<div class="form-content">
				<form action="team_modify.do" method="post" id="modify_form">
					...
					<div class="form-group align-left">
						...
						<input type="text" class="form-control" id="team_name" name="team_name" placeholder="Enter Team_Name" maxlength="10" autocomplete="off" value="${member.team_name }">
					</div>
					<div class="form-group align-left">
