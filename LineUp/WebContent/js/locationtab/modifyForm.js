$(document).ready(function(){
	...
	$('#loc_photo_btn').click(function(){
		$('<input type="hidden" class="form-control"  id="loc_photo_val" name="loc_photo_val" value="1">').appendTo('#loc_photo_div');
		$('<input type="file" class="form-control" id="loc_photo1" name="loc_photo1" accept="image/*">').appendTo('#loc_photo_div');
		$('#loc_photo_btn').addClass('hide');
	});
